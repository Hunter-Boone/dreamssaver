...
import { createCheckoutSession, createCustomerPortalSession } from "@/lib/stripe/stripeClient"
...
export default function SubscriptionPage() {
  ...
  const handleManageSubscription = async () => {
    ...
    try {
      ...
      setError(error instanceof Error ? error.message : 'Failed to access billing portal')
    } finally {
      setLoading(false)
    }
  }
    ...
    <div className="min-h-screen dream-gradient">
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="flex items-center space-x-4 mb-8">
          ...
          <div>
            <h1 className="text-2xl font-serif text-dreamy-lavender-900">Subscription</h1>
            <p className="text-soft-gray-600">Manage your Dreams Saver subscription</p>
          </div>
        </div>
            ...
            <CardTitle className="flex items-center space-x-2">
              {isPremium ? (
                <>
                  ...
                  <Badge className="bg-whisper-gold-100 text-whisper-gold-800">Active</Badge>
                </>
              ) : (
                <>
          ...
          <Card className="dream-card border-dreamy-lavender-300">
            ...
            <CardContent className="space-y-6">
              <div className="text-center">
                ...
                <p className="text-soft-gray-600">Billed monthly, cancel anytime</p>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-2">
                  <Check className="h-4 w-4 text-green-600" />
                  <span><strong>Unlimited AI insights</strong></span>
                </div>
                <div className="flex items-center space-x-2">
                  <Check className="h-4 w-4 text-green-600" />
